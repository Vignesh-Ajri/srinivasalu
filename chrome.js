...
(function(){
  ...
  // CV chronological order (req #7) — earliest → most recent
  window.SR_DEPTS_CV = [
    ...
    <header class="nav-bar" role="navigation" aria-label="Primary">
      <div class="container">
        ...
        <ul class="nav-primary">
          ...
          <li${active('about.html')}><a href="about.html">About</a></li>
          <li${active('honours.html')}><a href="honours.html">Honours</a></li>
  ...
  const mobileDrawer = `
    ...
    <aside class="mobile-drawer" id="mobileDrawer" role="dialog" aria-modal="true" aria-label="Menu">
      ...
      <nav class="mobile-nav">
        ...
        <a href="about.html"${mActive('about.html')}><i data-lucide="user" class="icon-sm"></i>About</a>
        <a href="honours.html"${mActive('honours.html')}><i data-lucide="award" class="icon-sm"></i>Honours</a>
